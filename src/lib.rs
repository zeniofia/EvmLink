...
#[derive(Debug)]
pub struct EvmLinkProcessor {
    verbose: bool,
    processed_count: usize,
}

impl EvmLinkProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting EvmLink processing");
    
    let mut processor = EvmLinkProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = EvmLinkProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = EvmLinkProcessor::new(false);
